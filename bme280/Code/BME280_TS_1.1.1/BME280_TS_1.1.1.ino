...
const float voltageScale = 229;  // 22 kOm + 100 kOm calculated for 4V input battery voltage and 3,3V upper voltage of A0 analogue inputs witch means 1024 after ADC

// Wi-Fi Settings
const char* ssid = "myNET2";
const char* password = "Li#lu~2014";
WiFiClient client;

// ThingSpeak Settings
const int channelID = 274380;
String writeAPIKey = "7EXDYOJAQ4OKD54R";
